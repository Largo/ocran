...
Gem::Specification.new do |spec|
  ...
  spec.description = "OCRAN (One-Click Ruby Application Next) packages Ruby applications for " \
  ...
  spec.metadata["changelog_uri"] = "https://github.com/largo/ocran/blob/master/CHANGELOG.txt"
